...
namespace OffroadCamping.Appointments.Infrastructure.Configuration;
...
public static class GoogleCredentials
{
    ...
    /// OffroadCamping.Appointments/Secrets/GoogleCredentials.json.
    /// </param>
    /// <returns></returns>
    public static GoogleCredential GetCredential(string credentialsPath)
    {
        var root = Assembly.GetExecutingAssembly().Location.Split("OffroadCamping.Appointments").First();
